...
export const endpoint = `https://hello-server-x9tw8.ondigitalocean.app/api/graphql`;
export const prodEndpoint = `https://hello-server-x9tw8.ondigitalocean.app/api/graphql`;
